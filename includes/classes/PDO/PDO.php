...
if (!class_exists('PDO')) {
    ...
    class PDO
    {
         ...
         */
        public function PDO($string_dsn, $string_username = '', $string_password = '', $array_driver_options = null)
        {
        ...
        public function __getDNS(&$string)
        {
            $result = array();
            $pos = strpos($string, ':');
    ...
    class _PDO
    {
        ...
        public function _PDO($string_dsn, $string_username = '', $string_password = '', $array_driver_options = null)
        {
            $con = &$this->__getDNS($string_dsn);
            if ($con['dbtype'] === 'mysql') {
                require_once 'PDO_mysql.class.php';
