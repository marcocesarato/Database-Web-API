...
class PDOStatement_sqlite
{
    ...
    public $__connection;
    public $__dbinfo;
    public $__persistent = false;
    public $__query = '';
    public $__result = null;
    public $__fetchmode = PDO::FETCH_BOTH;
    public $__errorCode = '';
    public $__errorInfo = array('');
     ...
     */
    public function PDOStatement_sqlite(&$__query, &$__connection, &$__dbinfo)
    {
    ...
    public function __setErrors($er, $connection = false)
    {
    ...
    public function bindColumn($mixewd, &$param, $type = null, $max_length = null, $driver_option = null)
    {
        return false;
    }
}
